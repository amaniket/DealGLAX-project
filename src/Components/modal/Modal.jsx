                                        ...
                                        <div className="flex flex-col items-center justify-center py-8 mx-auto  lg:py-0">
                                            ...
                                            <div className="w-full  rounded-lg md:mt-0 sm:max-w-md xl:p-0 ">
                                                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                                                    ...
                                                    <div>
                                                            <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900">Enter University Roll No</label>
                                                        ...
                                                        <div>
                                                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">Enter GLA Email Id</label>
                                                        ...
                                                        <div>
                                                            <label htmlFor="pincode" className="block mb-2 text-sm font-medium text-gray-900">Enter Phone No</label>
                                                    ...
                                                    <button onClick={ closeModal} type="button" className="focus:outline-none w-full text-white bg-blue-600 bg-blue-600 hover:bg-violet-800  outline-0 font-medium rounded-lg text-sm px-5 py-2.5 ">Request has been placed</button>
                                                </div>
                                            </div>
                                        </div>
                                    </section>
